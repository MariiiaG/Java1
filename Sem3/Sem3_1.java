...
и строки - неизменияемый тип, то нет смысла создавать новую строку с таким же содержимым -->  ссылка рдинкаова
 ...
 */
    ...
    static void test(int a, List<Integer> list, int[] arr) {
        ...
        list.add(5);  // Ссылочный тип. Изменения отражаются вне метожа
        arr[0] = 5;
    }
}